...
def do_sequence_prediction(args):
    ...
    with tf.Graph().as_default():
        ...
        with tf.Session() as session:
            summary_writer = tf.summary.FileWriter(config.summary_path + '/train', session.graph)
...
if __name__ == "__main__":
    ...
    command_parser.add_argument('-c', '--cell', choices=['rnn', 'gru', 'lstm'], default='lstm', help="Type of cell to use")
